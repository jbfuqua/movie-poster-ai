...
console.log('Anthropic key preview:', process.env.ANTHROPIC_API_KEY ? process.env.ANTHROPIC_API_KEY.substring(0, 15) + '...' : 'MISSING');
...
if (!ANTHROPIC_API_KEY) {
    console.error('❌ ANTHROPIC_API_KEY is missing! Please check your .env file.');
}
if (!OPENAI_API_KEY) {
